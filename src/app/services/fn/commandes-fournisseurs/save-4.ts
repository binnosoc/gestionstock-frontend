...
export function save4(http: HttpClient, rootUrl: string, params: Save4$Params, context?: HttpContext): Observable<StrictHttpResponse<SupplierOrderDto>> {
...
save4.PATH = '/gestionstock/v1/commandfournisseurs/create';
